    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            if ($data[$i]['id'] == 1) {
                ...
                <ispan class="material-icons">delete</ispan>
                </a>
                </div>';
            }
            ...
            if ($id_usuario == '') {
                ...
                if (empty($verificarCorreo)) {
                    ...
                    if (empty($verificarTel)) {
                        ...
                        if ($data > 0) {
                            $res = array('tipo' => 'success', 'mensaje' => 'USUARIO GUARDADO CORRETAMENTE');
                        } else {
                            $res = array('tipo' => 'error', 'mensaje' => 'NO SE PUEDE GUARDAR EL USUARIO');
                        }
                    } else {
    ...
    public function cambiarProfile()
    {
        ...
        || empty($telefono) || empty($direccion)) {
            ...
            $usuario = $this->model->getUsuario($this->id_usuario);
                    ...
                    if ($data == 1) {
                        $res = array('tipo' => 'success', 'mensaje' => 'DATOS MODIFICADA');
                    } else {
                        $res = array('tipo' => 'error', 'mensaje' => 'ERROR AL MODIFICAR');
                    }
        }
