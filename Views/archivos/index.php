                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card file-manager-group">
                            <div class="card-body d-flex align-items-center">
                                <i class="material-icons" style="color: #<?php echo $carpetas['color']; ?>">folder</i>
                                <div class="file-manager-group-info flex-fill">
                                    <a href="#" id="<?php echo $carpetas['id']; ?>" class="file-manager-group-title carpetas"><?php echo $carpetas['nombre']; ?></a>
                                    <span class="file-manager-group-about"><?php echo $carpetas['fecha']; ?></span>
                                </div>
                            </div>
                        </div>
